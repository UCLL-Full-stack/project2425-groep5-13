...
test('given: no KBO number; when: student assocation is created; then: error is thrown', () => {
    //when
    const studentAssociation = () => new StudentAssociation({kboNumber: '', name: name, users: [userGiven]})
    //then
...
test('given: no name; when: student assocation is created; then: error is thrown', () => {
    //when
    const studentAssociation = () => new StudentAssociation({kboNumber: kboNummer , name: "", users: [userGiven]})
    //then
...
test('given: no users; when: student assocation is created; then: error is thrown', () => {
    //when
    const studentAssociation = () => new StudentAssociation({kboNumber: kboNummer , name: name, users: []})
    //then
