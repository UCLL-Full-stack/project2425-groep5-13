import { Classroom as ClassroomPrisma, User as UserPrisma, Reservation as ReservationPrisma} from "@prisma/client"
...
export class Reservation{
    ...
    constructor(reservation: { id?: number; startTime: Date; endTime: Date; classroom: Classroom; user: User}){
    ...
    validate(reservation: {startTime: Date; endTime: Date; classroom: Classroom}){
        ...
        if (reservation.startTime.getMinutes() % 30 !== 0 || reservation.endTime.getMinutes() % 30 !== 0) {
