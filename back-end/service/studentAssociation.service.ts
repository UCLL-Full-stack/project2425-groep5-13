...
const addUserToStudentAssociation = async ({user, kboNumber}: {user: UserInput, kboNumber: string}): Promise<StudentAssociation> => studentAssociationDb.addUserToStudentAssociation({user, kboNumber})
